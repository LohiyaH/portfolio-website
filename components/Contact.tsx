      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-md mx-auto bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg p-8 transform hover:scale-105 transition-all duration-300">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <a href="https://www.linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-blue-600 text-white py-2 px-4 rounded-full hover:bg-blue-700 dark:hover:bg-blue-500 transition-all duration-300 transform hover:-translate-y-1">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            ...
            <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center bg-gray-800 text-white py-2 px-4 rounded-full hover:bg-gray-900 dark:hover:bg-gray-700 transition-all duration-300 transform hover:-translate-y-1">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
